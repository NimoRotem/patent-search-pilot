...
--
-- This schema is intentionally outside the application's numbered migration directory. It is
-- applied only to the isolated niche factory database, never to the live retrieval database.
